...
bot.on('guildMemberAdd', member => {
	if(member.guild.id == "720400697304285227") {
	...
	if(member.guild.id == "756379847164690554") {
		let welcomeChannel2 = member.guild.channels.cache.get('756424835269263426')
		welcomeChannel2.send(`Welcome, ${member} to **${member.guild.name}' Official Discord!**`); 
	}
});
...
bot.on('guildMemberRemove', member => {
	...
	if(member.guild.id == "756379847164690554") {
		let leaveChannel2 = member.guild.channels.cache.get('756424835269263426')
		leaveChannel2.send(`We are sorry you had to leave, ${member.user.tag} :(`);
		}
